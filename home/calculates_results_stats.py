...
def calculates_results_stats(results_dic):
    ...
    for value in results_dic.values():
        pet_is_dog,classified_as_dog = value[3], value[4]
        if pet_is_dog and classified_as_dog:
            results_stats_dic["n_correct_dogs"]+=1
        elif not pet_is_dog and not classified_as_dog:
    ...
    for value in results_dic.values():
        match,pet_is_dog = value[2],value[3]
